...
namespace NETSearch.DB.DBUtility
{
	...
	/// </summary>
	public sealed class FireBirdHelper
	{
		...
		public static int ExecuteNonQueryTypedParams(String connectionString, String spName, DataRow dataRow)
		{
			...
			if (dataRow != null && dataRow.ItemArray.Length > 0)
			{
                ...
                return FireBirdHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName, commandParameters);
			}
			else
			{
                return FireBirdHelper.ExecuteNonQuery(connectionString, CommandType.StoredProcedure, spName);
			}
		}
		...
		public static int ExecuteNonQueryTypedParams(FbConnection connection, String spName, DataRow dataRow)
		{
			...
			if (dataRow != null && dataRow.ItemArray.Length > 0)
			{
                ...
                return FireBirdHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName, commandParameters);
			}
			else
			{
                return FireBirdHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, spName);
			}
		}
		...
		public static int ExecuteNonQueryTypedParams(FbTransaction transaction, String spName, DataRow dataRow)
		{
			...
			if (dataRow != null && dataRow.ItemArray.Length > 0)
			{
                ...
                return FireBirdHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName, commandParameters);
			}
			else
			{
                return FireBirdHelper.ExecuteNonQuery(transaction, CommandType.StoredProcedure, spName);
			}
		}
		#endregion
		...
		public static DataSet ExecuteDatasetTypedParams(string connectionString, String spName, DataRow dataRow)
		{
			...
			if (dataRow != null && dataRow.ItemArray.Length > 0)
			{
                ...
                return FireBirdHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName, commandParameters);
			}
			else
			{
                return FireBirdHelper.ExecuteDataset(connectionString, CommandType.StoredProcedure, spName);
			}
		}
		...
		public static DataSet ExecuteDatasetTypedParams(FbConnection connection, String spName, DataRow dataRow)
		{
			...
			if (dataRow != null && dataRow.ItemArray.Length > 0)
			{
                ...
                return FireBirdHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName, commandParameters);
			}
			else
			{
                return FireBirdHelper.ExecuteDataset(connection, CommandType.StoredProcedure, spName);
			}
		}
		...
		public static DataSet ExecuteDatasetTypedParams(FbTransaction transaction, String spName, DataRow dataRow)
		{
			...
			if (dataRow != null && dataRow.ItemArray.Length > 0)
			{
                ...
                return FireBirdHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName, commandParameters);
			}
			else
			{
                return FireBirdHelper.ExecuteDataset(transaction, CommandType.StoredProcedure, spName);
			}
		}
		...
		public static FbDataReader ExecuteReaderTypedParams(String connectionString, String spName, DataRow dataRow)
		{
			...
			if (dataRow != null && dataRow.ItemArray.Length > 0)
			{
                ...
                return FireBirdHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName, commandParameters);
			}
			else
			{
                return FireBirdHelper.ExecuteReader(connectionString, CommandType.StoredProcedure, spName);
			}
		}
		...
		public static FbDataReader ExecuteReaderTypedParams(FbConnection connection, String spName, DataRow dataRow)
		{
			...
			if (dataRow != null && dataRow.ItemArray.Length > 0)
			{
                ...
                return FireBirdHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName, commandParameters);
			}
			else
			{
                return FireBirdHelper.ExecuteReader(connection, CommandType.StoredProcedure, spName);
			}
		}
		...
		public static FbDataReader ExecuteReaderTypedParams(FbTransaction transaction, String spName, DataRow dataRow)
		{
			...
			if (dataRow != null && dataRow.ItemArray.Length > 0)
			{
                ...
                return FireBirdHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
			}
			else
			{
                return FireBirdHelper.ExecuteReader(transaction, CommandType.StoredProcedure, spName);
			}
		}
		#endregion
		...
		public static object ExecuteScalarTypedParams(String connectionString, String spName, DataRow dataRow)
		{
			...
			if (dataRow != null && dataRow.ItemArray.Length > 0)
			{
                ...
                return FireBirdHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName, commandParameters);
			}
			else
			{
                return FireBirdHelper.ExecuteScalar(connectionString, CommandType.StoredProcedure, spName);
			}
		}
		...
		public static object ExecuteScalarTypedParams(FbConnection connection, String spName, DataRow dataRow)
		{
			...
			if (dataRow != null && dataRow.ItemArray.Length > 0)
			{
                ...
                return FireBirdHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName, commandParameters);
			}
			else
			{
                return FireBirdHelper.ExecuteScalar(connection, CommandType.StoredProcedure, spName);
			}
		}
		...
		public static object ExecuteScalarTypedParams(FbTransaction transaction, String spName, DataRow dataRow)
		{
			...
			if (dataRow != null && dataRow.ItemArray.Length > 0)
			{
                ...
                return FireBirdHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName, commandParameters);
			}
			else
			{
                return FireBirdHelper.ExecuteScalar(transaction, CommandType.StoredProcedure, spName);
			}
		}
		#endregion
		...
		public static XmlReader ExecuteXmlReaderTypedParams(FbConnection connection, String spName, DataRow dataRow)
		{
			...
			if (dataRow != null && dataRow.ItemArray.Length > 0)
			{
                ...
                return FireBirdHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters);
			}
			else
			{
                return FireBirdHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName);
			}
		}
		...
		public static XmlReader ExecuteXmlReaderTypedParams(FbTransaction transaction, String spName, DataRow dataRow)
		{
			...
			if (dataRow != null && dataRow.ItemArray.Length > 0)
			{
                ...
                return FireBirdHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
			}
			else
			{
                return FireBirdHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName);
			}
		}
		#endregion
